...
class EditDataPage extends StatefulWidget {
  EditDataPage({Key? key, required this.toDos}) : super(key: key);
...
class _EditDataPageState extends State<EditDataPage> {
  ...
  void initState() {
    ...
    task_descriptionController.text = toDos.task_description;
    task_titleController.text = toDos.task_title;
    dateInput.text = toDos.doneDate;
              ...
              GestureDetector(
                onTap: () async {
                  if (formKey.currentState!.validate()) {
                    ...
                    FireBaseCloudHelpper.fireBaseCloudHelpper.updateUser(
                      id: toDos.id,
